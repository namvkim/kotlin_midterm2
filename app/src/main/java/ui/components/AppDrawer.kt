...
fun ScreenNavigationButtonPreview(){
    ScreenNavigationButton(icon = Icons.Filled.Home, label = "Home", isSelected = true ) {
    }
}
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            label = "Home",
            isSelected = currentScreen === Screen.Product,
            onClick = {
                JetNotesRouter.navigateTo(Screen.Product)
                closeDrawerAction()
            }
        )
